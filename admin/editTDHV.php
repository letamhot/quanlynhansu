  ...
  <div class="content-wrapper container">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sửa Trình độ học vấn</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Trình độ học vấn</a></li>
              <li class="breadcrumb-item active">Sửa Trình độ học vấn</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <form action="controller/updateTDHV.php" method="post" enctype="multipart/form-data">
            <div class="profile_edit">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="header_content">
                            <div class="header__content_title">
                                <h3><i class="mdi mdi-plus-circle-outline menu-icon"></i>Cập nhật Trình độ học vấn</h3>
                            </div>
                            <div class="header__buttom_edit">
                                <button type="submit" name="btnLuuTDHV" class="btn btn-primary">
                ...
                <div class="bg-light">
                    ...
                    <?php 
                            ...
                            $sql_cv = "SELECT * FROM trinhdohocvan WHERE id = '".$_GET['id']."'";
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tenTrinhDoHocVan" value="<?php echo $value['tenTrinhDoHocVan']; ?>" class="form-control">
                            </div>
