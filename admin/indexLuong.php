            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="header_content">
                    <div class="header__content_title">
                        <h3><i class="mdi mdi-newspaper menu-icon"></i>Danh sách lương</h3>
                    </div>
                    <div class="header__buttom_edit">
                        ...
                        <a href="createLuong.php" class="btn btn-primary">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            // tim tong so records
                            $result = mysqli_query($conn, 'select count(id) as total from luong');
                            ...
                            $sql = "SELECT * FROM luong LIMIT $start, $limit";
                            ...
                            if ($result != null) {
                                ...
                                if ($resultSQL != 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        if ($role == 1) {
                                            echo "<td class='text-center'><a href=\"editLuong.php?id=" . $row['id'] . "\"><i class='mdi mdi-rename-box menu-icon'></i></a></td>";
                                            echo "<td class='text-center'><a href=\"deleteLuong.php?id=" . $row['id'] . "\"> <i class='mdi mdi-delete menu-icon'></i></a></td>";
                                        } else {
                                        }
                                ...
                                echo "<tbody>";
                                echo "<tr>";
                                echo "<td colspan='6' class='__waiting'>Không có dữ liệu nào </td>";
                                echo "</tr>";
                                echo "</tbody>";
                            }
