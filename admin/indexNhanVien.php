                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <?php
                                    ...
                                    if($result != null) 
                                    {
                                        $sql1 = "SELECT * FROM trinhdohocvan";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            if($row["tenNV"] != "Administrator"){
                                                ...
                                                echo "<tr>";
                                                    ...
                                                    echo "<td>".($row["trinhDoHocVan"] == $value1["id"] ? $value1["tenTrinhDoHocVan"] : ""). "</td>";
                                                    ...
                                                    echo "<td>".($row["luong"] == $value4["id"] ? $value4["heSoLuong"] : ""). "</td>";
