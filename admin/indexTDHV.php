                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="header_content">
                        <div class="header__content_title">
                            <h3><i class="mdi mdi-newspaper menu-icon"></i>Danh sách Trình độ học vấn</h3>
                        </div>
                        <div class="header__buttom_edit">
                            <a href="createTDHV.php" class="btn btn-primary">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <?php
                                    ...
                                    // tim tong so records
                                    $result = mysqli_query($conn, 'select count(id) as total from trinhdohocvan');
                                    ...
                                    $sql = "SELECT * FROM trinhdohocvan LIMIT $start, $limit";
                                    ...
                                    if($result != null) 
                                    {
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            echo "<tbody>";
                                                echo "<tr>";
                                                    echo "<td>". $row["id"]."</td>";
                                                    echo "<td>".$row["tenTrinhDoHocVan"]. "</td>";
                                                    if($role == 1)
                                                    {
                                                        echo "<td class='text-center'><a href=\"editTDHV.php?id=".$row['id']."\"><i class='mdi mdi-rename-box menu-icon'></i></a></td>";
                                                        echo "<td class='text-center'><a href=\"deleteTDHV.php?id=".$row['id']."\"> <i class='mdi mdi-delete menu-icon'></i></a></td>";
                                                    }
                                                    else
                                                    {
